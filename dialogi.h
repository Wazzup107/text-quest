...
#define makeScene4(sceneName, text, var1, fun1, var2, fun2, var3, fun3, var4,  \
                   fun4)                                                       \
  bool sceneName() {                                                           \
    cout << text << endl                                                       \
         << "1." << var1 << endl                                               \
...
#define makeScene1Back(sceneName, text, var1, fun1)                            \
  bool sceneName() {                                                           \
    cout << text << endl                                                       \
         << "1." << var1 << endl                                               \
         << "Введите любой другой символ, чтобы перейти назад\n";              \
    int varik;                                                                 \
    cin >> varik;                                                              \
    bool result;                                                               \
    switch (varik) {                                                           \
...
#define makeScene4Back(sceneName, text, var1, fun1, var2, fun2, var3, fun3,    \
                       var4, fun4)                                             \
  bool sceneName() {                                                           \
    cout << text << endl                                                       \
         << "1." << var1 << endl                                               \
